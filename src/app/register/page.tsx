          ...
          <div>
            <button onClick={async () => {
              const { error } = await supabase.auth.signInWithOAuth({
                provider: "google",
                options: { redirectTo: "https://splinters.co.ke/dashboard" }
              });
              if (error) setError(error.message);
            }}
              style={{ width: "100%", background: "#ffffff", color: "#111", padding: "0.85rem", borderRadius: "100px", border: "none", fontSize: "0.9rem", fontWeight: "600", cursor: "pointer", marginBottom: "1.25rem", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.75rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.25rem" }}>
              ...
              <span style={{ fontSize: "0.65rem", color: "rgba(255,255,255,0.25)", letterSpacing: "2px" }}>OR</span>
              <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.08)" }} />
            </div>
