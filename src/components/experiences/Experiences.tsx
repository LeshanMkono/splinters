"use client" ;export default function Experiences() {
  const experiences = [
    {
    ...
    <section id="experiences" style={{ position: "relative", padding: "5rem 1.5rem", minHeight: "60vh" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px,1fr))", gap: "1.5rem" }}>
          {experiences.map(exp => (
            <div key={exp.title}
              style={{ background: "rgba(0,0,0,0.5)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "16px", overflow: "hidden", backdropFilter: "blur(8px)", display: "flex", flexDirection: "column" as const, transition: "transform 0.2s, border-color 0.2s" }}
              onMouseEnter={e => {
                (e.currentTarget as HTMLElement).style.transform = "translateY(-4px)";
                (e.currentTarget as HTMLElement).style.borderColor = "rgba(232,87,12,0.5)";
              }}
              onMouseLeave={e => {
              ...
              <div style={{ position: "relative", height: "200px", overflow: "hidden" }}>
                ...
                <div style={{ position: "absolute", top: "0.75rem", left: "0.75rem", background: "rgba(232,87,12,0.9)", color: "#111", fontSize: "0.6rem", padding: "3px 10px", borderRadius: "100px", fontWeight: "500", letterSpacing: "1px", textTransform: "uppercase" as const }}>
                  {exp.tag}
                </div>
                <div style={{ position: "absolute", top: "0.75rem", right: "0.75rem", background: "rgba(0,0,0,0.6)", color: "rgba(255,255,255,0.7)", fontSize: "0.6rem", padding: "3px 10px", borderRadius: "100px", letterSpacing: "0.5px" }}>
                  {exp.duration}
                </div>
              </div>
              ...
              <div style={{ padding: "1.25rem", flex: 1, display: "flex", flexDirection: "column" as const }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <a href="#" style={{ background: "#E8570C", color: "#111", padding: "0.5rem 1.25rem", borderRadius: "100px", textDecoration: "none", fontSize: "0.8rem", fontWeight: "500", transition: "opacity 0.2s" }}
